...
\begin{enumerate}
  \item Find parameter values for a logistic differential equation that fit the crude oil production data for the U.S. (see Table \ref{oil1}).\sidenote{Data from Twentieth Century Petroleum Statistics, 1984, by DeGolyer and MacNaughton and http://www.eia.doe.gov} Parameter values include the proportionality constant, carrying capacity, and integration constant.
